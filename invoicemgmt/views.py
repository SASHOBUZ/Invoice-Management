...
def add_invoice(request):
    total_invoices = Invoice.objects.count()
    queryset = Invoice.objects.order_by('total')[:8]
        ...
        def import_data(data_file):
            ...
            for row in invoice_data:
                ...
                generate_invoice(str(name), str(invoice_number),
                    ...
                    str(line_six), str(line_six_quantity),
                    str(line_six_unit_price), str(
                        line_six_total_price), str(line_seven),
                    str(line_seven_quantity), str(line_seven_unit_price),
                    str(line_seven_total_price), str(
                        line_eight), str(line_eight_quantity),
                    str(line_eight_unit_price), str(
                        line_eight_total_price), str(line_nine),
                    str(line_nine_quantity), str(
                        line_nine_unit_price), str(line_nine_total_price),
                    str(line_ten), str(line_ten_quantity), str(
                        line_ten_unit_price),
                    str(line_ten_total_price), str(total),
                    str(phone_number), str(invoice_date),
